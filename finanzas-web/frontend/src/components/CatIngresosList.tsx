        ...
        {loading ? (
          <div className="flex flex-col gap-0">
            <div className="grid grid-cols-[2fr_1.2fr_1.2fr_1fr] px-5 py-3 border-b border-border">
              {['NOMBRE','CANTIDAD DE INGRESOS','TOTAL INGRESADO','ACCIONES'].map((h) => (
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="text-left px-5 py-3 text-xs font-bold text-muted-foreground uppercase tracking-widest">Cantidad de ingresos</th>
                <th className="text-left px-5 py-3 text-xs font-bold text-muted-foreground uppercase tracking-widest">Total ingresado</th>
                ...
                >
                  ...
                  <td className="px-5 py-3.5">
                    <span className="inline-flex items-center gap-2.5 font-semibold text-foreground">
                      <span className="size-7 rounded-full bg-emerald-50 dark:bg-muted flex items-center justify-center shrink-0">
                  ...
                  {/* Cantidad */}
                  <td className="px-5 py-3.5 text-foreground">{cat.cantidad_ingresos ?? 0}</td>
                  {/* Total */}
                  <td className="px-5 py-3.5 font-semibold text-income">
            ...
            <div className="flex items-start justify-between">
              <div>
                <h3 className="text-xl font-bold font-display text-foreground">
                  Crear en categorías de ingresos
                </h3>
