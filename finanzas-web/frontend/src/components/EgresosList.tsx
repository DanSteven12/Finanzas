      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4">
        <div className="rounded-2xl border border-border bg-card p-4 flex items-center justify-between shadow-xs">
          <div>
            ...
            <p className="text-2xl font-bold font-display text-expense mt-1">
              ${totalGastado.toLocaleString('es-MX', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              <span className="text-xs text-muted-foreground ml-1 font-normal">MXN</span>
            </p>
          </div>
          <span className="size-10 rounded-full bg-danger-soft flex items-center justify-center text-expense text-lg font-bold">
            −
          </span>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-card p-4 flex items-center justify-between shadow-xs">
          <div>
            <p className="text-xs font-semibold text-muted-foreground uppercase tracking-wider">Gastos Registrados</p>
            <p className="text-2xl font-bold font-display text-foreground mt-1">
              {totalCount}
              <span className="text-xs text-muted-foreground ml-1 font-normal">movimientos</span>
            </p>
          </div>
          <span className="size-10 rounded-full bg-muted flex items-center justify-center text-muted-foreground text-base">
            🧾
          </span>
        </div>
      </div>
                ...
                {paginated.map((egreso) => (
                  ...
                  >
                    ...
                    <td className="px-5 py-3.5">
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold bg-danger-soft text-expense border border-expense/20">
                        <span className="size-1.5 rounded-full bg-expense inline-block" />
                        {egreso.categoria_nombre || 'Sin categoría'}
                      </span>
                    </td>
                    {/* Monto */}
                    <td className="px-5 py-3.5 font-bold text-expense text-base">
