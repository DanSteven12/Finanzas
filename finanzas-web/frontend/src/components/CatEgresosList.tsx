            ...
            <table className="w-full text-left">
              <thead>
                <tr className="border-b border-border/80">
                  ...
                  <th className="px-6 py-3.5 text-[11px] font-extrabold text-muted-foreground uppercase tracking-wider">CANTIDAD DE GASTOS</th>
                  <th className="px-6 py-3.5 text-[11px] font-extrabold text-muted-foreground uppercase tracking-wider">TOTAL GASTADO</th>
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span className="inline-flex items-center gap-3 font-bold text-foreground text-sm sm:text-base">
                        <span className="size-8 rounded-full bg-red-50 dark:bg-muted flex items-center justify-center shrink-0">
                    ...
                    {/* Cantidad */}
                    <td className="px-6 py-4 text-sm font-semibold text-foreground">{cat.cantidad_gastos ?? 0}</td>
                    {/* Total */}
                    <td className="px-6 py-4 text-sm sm:text-base text-expense font-extrabold font-display">
